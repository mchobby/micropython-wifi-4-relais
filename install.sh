...
cp /home/domeu/Téléchargements/upy/rp2-pico-w-20220725-unstable-v1.19.1-205-g4fe3e493b.uf2 /media/domeu/RPI-RP2/
...
mpremote connect $SER fs cp www/index.html :www/index.html
